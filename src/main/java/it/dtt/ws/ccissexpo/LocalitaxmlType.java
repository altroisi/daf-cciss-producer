...
public class LocalitaxmlType {
    ...
    @XmlAttribute(name = "tipo", namespace = "http://ccissexpo.ws.dtt.it")
    protected String tipo;
    @XmlAttribute(name = "locid", namespace = "http://ccissexpo.ws.dtt.it")
    protected String locid;
    @XmlAttribute(name = "prov", namespace = "http://ccissexpo.ws.dtt.it")
    protected String prov;
    @XmlAttribute(name = "reg", namespace = "http://ccissexpo.ws.dtt.it")
    protected String reg;
    @XmlAttribute(name = "lng", namespace = "http://ccissexpo.ws.dtt.it")
    protected String lng;
    @XmlAttribute(name = "lat", namespace = "http://ccissexpo.ws.dtt.it")
    protected String lat;
    @XmlAttribute(name = "code", namespace = "http://ccissexpo.ws.dtt.it")
